...
using TalentHire.Services.IdentityService.Data; // Update this line to the correct namespace
using TalentHire.Services.IdentityService.Models; // Update this line to the correct namespace
